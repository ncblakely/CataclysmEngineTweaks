...
static_assert(offsetof(AIPlayer, aiplayerDifficultyLevel) == 0x4);
static_assert(offsetof(AIPlayer, ResourceFeatures) == 0x8);
static_assert(offsetof(AIPlayer, AttackFeatures) == 0xC);
static_assert(offsetof(AIPlayer, DefenseFeatures) == 0x10);

// static_assert(offsetof(AIPlayer, aifHyperSkimming) == 0xB9C);
